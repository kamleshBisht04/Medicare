...
const MyAppointments = () => {
  ...
  return (
    <div>
      <p className="mt-12 border-b border-gray-300 pb-3 text-2xl font-medium text-zinc-700">
        My appointments
      </p>
      <div>
        {doctors.slice(0, 3).map((item, index) => (
          <div
            className="mb-6 grid grid-cols-[1fr_2fr] gap-4 border-b border-gray-200 py-2 sm:flex sm:gap-6"
            key={index}
          >
            <div>
              <img
