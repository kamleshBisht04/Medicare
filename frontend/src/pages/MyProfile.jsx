    ...
    userData && (
      <div className="min-h-screen px-4 py-4">
        <div className="mx-auto max-w-6xl overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-xl">
          {/* Top Section */}
          <div className="gradient-myprofile flex flex-col gap-6 border-b-1 border-gray-200 px-10 py-6 pb-8 md:flex-row md:items-center md:justify-between">
            {/* Left */}
            <div className="flex flex-col items-center gap-5 md:flex-row">
              ...
              <div className="relative">
                <img
                  src={
                    imageFile ? URL.createObjectURL(imageFile) : userData?.image
                  }
                  alt="profile"
            ...
            <button
              ...
              className="text-primary flex items-center gap-2 rounded-xl bg-white px-5 py-2.5 text-sm font-medium transition-all hover:opacity-90"
            >
              {isEdit ? (
                <>
