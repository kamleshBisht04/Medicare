...
const BottomBanner = () => {
  ...
  return (
    <div className="gradient-banner my-20 flex rounded-lg px-6 sm:px-10 md:mx-10 md:px-14 lg:px-12">
      {/* left section */}
      <div className="flex-1 py-8 sm:py-10 md:py-16 lg:py-24 lg:pl-5">
        <div className="text-xl font-semibold text-white sm:text-2xl md:text-3xl lg:text-5xl">
          <p>Book Appointment</p>
          <p className="mt-4 text-white/90 md:text-2xl">
            with 100+ Trusted Doctors and Get Quality Healthcare Anytime,
            Anywhere
          </p>
