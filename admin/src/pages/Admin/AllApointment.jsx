  ...
  return (
    <div className="mt-12 min-h-screen w-full bg-[#f8fafc] p-3 sm:p-4 md:p-5 lg:p-6">
      ...
      <div className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm sm:rounded-2xl">
        ...
        <div className="hidden grid-cols-[0.4fr_2.5fr_1.5fr_1.3fr_1fr_1fr_1fr_1.2fr] gap-4 border-b border-gray-200 bg-gray-50/80 px-6 py-4 text-xs font-semibold tracking-wide text-gray-500 uppercase md:grid">
          <p>#</p>
          <p>Patient</p>
          <p>Doctor</p>
          <p>Date & Time</p>
        ...
        {appointments?.length > 0 ? (
          appointments.map((item, index) => (
            <div
              key={item._id}
              className="border-b border-gray-100 px-3 py-4 transition-all duration-200 last:border-b-0 hover:bg-gray-50/60 sm:px-5 sm:py-4 md:grid md:grid-cols-[0.4fr_2.5fr_1.5fr_1.3fr_1fr_1fr_1fr_1.2fr] md:items-center md:gap-4 md:px-6"
            >
              {/* ================= MOBILE LAYOUT ================= */}
              <div className="md:hidden">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="mt-0.5 truncate text-xs text-gray-500">
                      {item.docData?.speciality || "Doctor"}
                    </p>
                  </div>
